<?php 
	...
	if(isset($_POST['sign_in'])){
        ...
        if($check_user==1){
            // passing the email so that when user clicks signin it show that user is online
            ...
            echo "<script>window.open('Dashboard/dashboard.php?user_name=$user_name','_self')</script>";
